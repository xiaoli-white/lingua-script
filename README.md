...
| `compiler.rs` | Compiles AST into bytecode instructions |
| `instruction.rs` | Bytecode instruction set (~52 instructions) |
...
55 integration tests cover number parsing, variables, arithmetic, comparisons, logic, control flow, lists, maps, types, functions, classes, exceptions, and GC shared references.
